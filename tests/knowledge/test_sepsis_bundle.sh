...
assert_contains "bundle review cadence stays quarterly" "next_review: \"2026-09-30\"" "$bundle_text"
assert_contains "bundle reflects bolus threshold" "lactate >= 4 mmol/L" "$bundle_text"
assert_contains "bundle reflects bedside alert threshold" "Lactate > 2" "$bundle_text"
assert_not_contains "bundle drops the old bedside phrasing" "lactic > 2ish" "$bundle_text"
assert_contains "freshness review cadence stays quarterly" "| sepsis-bundle.md | Surviving Sepsis Campaign 2026 / CMS SEP-1 | 2026 | 2026-04-01 | 2026-09-30 | CURRENT |" "$freshness_text"
