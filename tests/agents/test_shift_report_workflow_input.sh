...
NARRATIVE_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/build-shift-report-workflow-input.mjs" '{"clinical_narrative":"62yo M day 3 MICU septic shock on levo"}')"
...
PATIENT_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/build-shift-report-workflow-input.mjs" '{"patient_id":"patient-123"}')"
...
MISSING_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/build-shift-report-workflow-input.mjs" '{}')"
