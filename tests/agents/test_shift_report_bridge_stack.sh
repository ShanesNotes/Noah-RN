...
PATIENT_JSON="$(node "$REPO_ROOT/.pi/extensions/noah-router/describe-shift-report-bridge-stack.mjs" '{"patient_id":"patient-123"}')"
...
MISSING_JSON="$(node "$REPO_ROOT/.pi/extensions/noah-router/describe-shift-report-bridge-stack.mjs" '{}')"
