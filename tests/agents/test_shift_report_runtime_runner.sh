...
NARRATIVE_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/run-shift-report-bridge.mjs" '{"clinical_narrative":"62yo M day 3 MICU septic shock on levo"}')"
...
MISSING_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/run-shift-report-bridge.mjs" '{}')"
...
PATIENT_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/run-shift-report-bridge.mjs" '{"patient_id":"patient-123"}')"
