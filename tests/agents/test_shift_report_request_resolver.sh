...
PATIENT_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/resolve-shift-report-request.mjs" '{"patient_id":"patient-123"}')"
...
NARRATIVE_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/resolve-shift-report-request.mjs" '{"clinical_narrative":"62yo M day 3 MICU septic shock on levo"}')"
...
MISSING_JSON="$(node "$PI_RUNTIME_DIR/extensions/noah-router/resolve-shift-report-request.mjs" '{}')"
