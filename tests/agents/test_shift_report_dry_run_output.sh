...
NARRATIVE_JSON="$(node "$REPO_ROOT/.pi/extensions/noah-router/build-shift-report-dry-run-output.mjs" '{"clinical_narrative":"62yo M day 3 MICU septic shock on levo"}')"
...
PATIENT_JSON="$(node "$REPO_ROOT/.pi/extensions/noah-router/build-shift-report-dry-run-output.mjs" '{"patient_id":"patient-123"}')"
