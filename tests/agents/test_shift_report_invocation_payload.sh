...
PATIENT_JSON="$(node "$REPO_ROOT/.pi/extensions/noah-router/build-shift-report-invocation-payload.mjs" '{"patient_id":"patient-123"}')"
...
NARRATIVE_JSON="$(node "$REPO_ROOT/.pi/extensions/noah-router/build-shift-report-invocation-payload.mjs" '{"clinical_narrative":"62yo M day 3 MICU septic shock on levo"}')"
...
MISSING_JSON="$(node "$REPO_ROOT/.pi/extensions/noah-router/build-shift-report-invocation-payload.mjs" '{}')"
