...
2. **Clinical workspace** - Medplum-backed EHR development environment with patient chart context, vitals, labs, meds, and clinician UI.
...
knowledge/       Curated protocols, drug ranges, templates, provenance
