...
See [`docs/ARCHITECTURE.md`](../../ARCHITECTURE.md) for current architecture direction and [`docs/FHIR-INTEGRATION.md`](../../FHIR-INTEGRATION.md) for FHIR platform documentation.
...
- **[ResusMonitor](https://www.resusmonitor.com/)**
