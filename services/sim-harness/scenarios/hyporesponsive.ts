...
export const hyporesponsive: ScenarioDefinition = {
  ...
  obligations: [
    {
      key: 'hyporesponsive-escalate-pressor-support',
      label: 'Escalate refractory shock support plan',
      startMinute: 0,
      dueMinute: 15,
      priority: 'high',
      ownedBy: 'provider',
      resolveByActions: ['add_medication'],
    },
    {
      key: 'hyporesponsive-review-abg',
      label: 'Review ABG and reassess shock trajectory',
      startMinute: 25,
      dueMinute: 35,
      priority: 'high',
      ownedBy: 'noah',
      resolveByActions: ['add_medication'],
      triggeredByEventKey: 'hyporesponsive-abg',
    },
  ],
};
